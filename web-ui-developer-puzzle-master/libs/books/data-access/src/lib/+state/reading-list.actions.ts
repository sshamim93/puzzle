...
export const updateReadingItem = createAction(
  '[Reading List] Update item in list',
  props<{ item: ReadingListItem }>()
);

export const confirmUpdateReadingItem = createAction(
  '[Reading List] Confirmed item update in list',
  props<{ item: ReadingListItem }>()
);

export const failedUpdateReadingItem = createAction(
  '[Reading List] Failed to Update item in list',
  props<{ item: ReadingListItem }>()
);